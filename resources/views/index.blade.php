    ...
    <section id="services" class="section">
        <div class="container">
          <div class="section-header">          
            ...
            <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Our ERP cloud system software solutions <br>use intelligent technology to help you grow, innovate, and optimize time and resources.</p>
          </div>
          <div class="row">
